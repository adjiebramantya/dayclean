    ...
    <div class="container">
      ...
      <div class="row">
          <div class="col-sm-6 col-md-offset-3">
            <form action="<?php echo site_url('user/order/tambah_treatment');?>" method="post" >
                ...
                <div class="row">
                  ...
                  <tbody>
                    ...
                    <tr> 
                      ...
                      <td>
                          <a href="<?php echo site_url('user/order/hapus_treatment/'.$id_treatment); ?>" class="btn btn-danger">Hapus</a>
                      </td>
                    </tr>
                  <?php }?> 
                  </tbody>
                  <tfoot>
                    <tr>
                      ...
                      <form action="<?php echo site_url('user/order/simpan_total/'.$invoice);?>" method="post" >
                      <td>
